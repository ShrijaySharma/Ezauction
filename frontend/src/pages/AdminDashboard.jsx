              ...
              <div className="bg-gray-800 rounded-xl max-w-6xl w-full max-h-[90vh] flex flex-col border-2 border-purple-500">
                <div className="flex justify-between items-center p-6 border-b border-gray-700 bg-gray-800 rounded-t-lg sticky top-0 z-10">
                  <div className="flex items-center gap-4">
                    ...
                    <button
                      onClick={() => window.open('/api/admin/export-teams', '_blank')}
                      className="px-4 py-2 bg-green-600 hover:bg-green-700 text-white font-bold rounded flex items-center gap-2 transition-colors shadow-lg"
                      title="Export all data to an Excel file"
                    >
